...
Only these properties are required for a web app:
...
| okta.oauth2.acrValues         |                 | false    | The Authentication Context Reference supported by Okta in /authorize API. See [here](https://developer.okta.com/docs/reference/api/oidc/#request-parameters) for usage details.                                                                       |
| okta.oauth2.enrollAmrValues   |                 | false    | Space-delimited, case-sensitive string that represents a list of authenticator method references to be passed as query param in /authorize API. See [here](https://developer.okta.com/docs/reference/api/oidc/#request-parameters) for usage details. |
| okta.oauth2.enrollmentCallbackUri |                 | false    | Callback URI that Okta should send the enrollment result to. User app should listen to this URI for enrollment result from Okta and handle it.                                                                                                        |
